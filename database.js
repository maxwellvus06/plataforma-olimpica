...
const PERMISSOES = {
    ADM: {
        abas: ["dashboard", "calendario", "importar", "relatorios", "reuniao", "plataforma", "monitoria", "alunos", "usuarios", "olimpiadas", "cidades", "escolas", "layout"],
    ...
    Aluno: {
        abas: ["meusresultados", "plataforma", "monitoria"],
        dashboard: { filtroTravado: true },
        calendario: { podeEditar: false },
        resultados: { podeEditar: false },
